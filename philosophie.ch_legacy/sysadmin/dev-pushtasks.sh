...
required_vars=( "LOCAL_REPORTS_PATH" "DEV_CONTAINER_BASENAME" )
...
docker cp "${LOCAL_REPORTS_PATH}/portal-tasks" "${rails_container}:/app/" && echo "=> Push complete" || echo "=> Push failed"
