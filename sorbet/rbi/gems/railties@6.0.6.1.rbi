...
module Rails
  ...
  class << self
    ...
    # source://railties//lib/rails.rb#40
    def application; end
    ...
    # source://railties//lib/rails.rb#115
    def autoloaders; end
    ...
    #
    # source://railties//lib/rails.rb#73
    def env; end
    ...
    #
    # source://railties//lib/rails.rb#80
    ...
    #
    # source://railties//lib/rails.rb#95
    ...
    #
    # source://railties//lib/rails.rb#111
    def public_path; end
...
class Rails::Application < ::Rails::Engine
  ...
  # source://railties//lib/rails/engine.rb#508
  ...
  #
  # source://railties//lib/rails/application.rb#436
  def credentials; end
  ...
  #
  # source://railties//lib/rails/application.rb#505
  def eager_load!; end
  ...
  #
  # source://railties//lib/rails/application.rb#306
  ...
  # source://railties//lib/rails/application.rb#368
  def initializers; end

  # Sends the +isolate_namespace+ method up to the class method.
  #
  # source://railties//lib/rails/application.rb#311
  ...
  # +railties_order+.
  #
  # source://railties//lib/rails/application.rb#500
  def migration_railties; end

  # If you try to define a set of Rake tasks on the instance, these will get
  # passed up to the Rake tasks defined on the application's class.
  #
  # source://railties//lib/rails/application.rb#281
  ...
  # source://railties//lib/rails/application.rb#337
  ...
  #
  # source://railties//lib/rails/application.rb#294
  def runner(&blk); end
  ...
  #
  # source://railties//lib/rails/application.rb#394
  def secrets; end
  ...
  # API.
  #
  # source://railties//lib/rails/application.rb#349
  ...
  # source://railties//lib/rails/application.rb#582
  ...
  # source://railties//lib/rails/application.rb#593
  ...
  class << self
    ...
    #
    # source://railties//lib/rails/application.rb#330
...
# source://railties//lib/rails/application/configuration.rb#11
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  ...
  # source://railties//lib/rails/application/configuration.rb#297
  def annotations; end

  # Returns the value of attribute api_only.
  #
  # source://railties//lib/rails/application/configuration.rb#24
  def api_only; end

  # source://railties//lib/rails/application/configuration.rb#174
  ...
  # source://railties//lib/rails/application/configuration.rb#309
  ...
  # source://railties//lib/rails/application/configuration.rb#257
  def colorize_logging; end

  # source://railties//lib/rails/application/configuration.rb#261
  ...
  # source://railties//lib/rails/application/configuration.rb#301
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#225
  def database_configuration; end

  # source://railties//lib/rails/application/configuration.rb#181
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#185
  def debug_exception_response_format=(_arg0); end

  # source://railties//lib/rails/application/configuration.rb#321
  ...
  # source://railties//lib/rails/application/configuration.rb#166
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#210
  def load_database_yaml; end

  # Loads default configurations. See {the result of the method for each version}[https://guides.rubyonrails.org/configuring.html#results-of-config-load-defaults].
  #
  # source://railties//lib/rails/application/configuration.rb#79
  ...
  # source://railties//lib/rails/application/configuration.rb#187
  def paths; end
  ...
  # source://railties//lib/rails/application/configuration.rb#266
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # @return [Boolean]
  #
  # source://railties//lib/rails/application/configuration.rb#293
...
class Rails::Application::Configuration::Custom
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#334
  def initialize; end
...
class Rails::Application::DefaultMiddlewareStack
  ...
  # source://railties//lib/rails/application/default_middleware_stack.rb#82
  def load_rack_cache; end

  # source://railties//lib/rails/application/default_middleware_stack.rb#104
...
# source://railties//lib/rails/application/finisher.rb#146
module Rails::Application::Finisher::InterlockHook
  class << self
    # source://railties//lib/rails/application/finisher.rb#151
    def complete(_state); end

    # source://railties//lib/rails/application/finisher.rb#147
    def run; end
  end
end

# source://railties//lib/rails/application/finisher.rb#132
class Rails::Application::Finisher::MutexHook
  # @return [MutexHook] a new instance of MutexHook
  #
  # source://railties//lib/rails/application/finisher.rb#133
  def initialize(mutex = T.unsafe(nil)); end

  # source://railties//lib/rails/application/finisher.rb#141
  def complete(_state); end

  # source://railties//lib/rails/application/finisher.rb#137
  def run; end
end
...
# source://railties//lib/rails/application.rb#620
...
class Rails::Application::RoutesReloader
  ...
  # source://railties//lib/rails/application/routes_reloader.rb#18
  def reload!; end
  ...
  # source://railties//lib/rails/application/routes_reloader.rb#43
  def finalize!; end

  # source://railties//lib/rails/application/routes_reloader.rb#39
  def load_paths; end

  # source://railties//lib/rails/application/routes_reloader.rb#47
  def revert; end

  # source://railties//lib/rails/application/routes_reloader.rb#28
  def updater; end
end
...
# source://railties//lib/rails/configuration.rb#90
class Rails::Configuration::Generators
  # @return [Generators] a new instance of Generators
  #
  # source://railties//lib/rails/configuration.rb#94
  def initialize; end

  # Returns the value of attribute aliases.
  #
  # source://railties//lib/rails/configuration.rb#91
  def aliases; end
  ...
  #
  # source://railties//lib/rails/configuration.rb#92
  def hidden_namespaces; end

  # source://railties//lib/rails/configuration.rb#111
  def hide_namespace(namespace); end

  # source://railties//lib/rails/configuration.rb#115
  def method_missing(method, *args); end
...
#
# source://railties//lib/rails/configuration.rb#37
class Rails::Configuration::MiddlewareStackProxy
  # @return [MiddlewareStackProxy] a new instance of MiddlewareStackProxy
  #
  # source://railties//lib/rails/configuration.rb#38
  def initialize(operations = T.unsafe(nil), delete_operations = T.unsafe(nil)); end

  # source://railties//lib/rails/configuration.rb#82
  def +(other); end

  # source://railties//lib/rails/configuration.rb#65
  def delete(*args, &block); end

  # source://railties//lib/rails/configuration.rb#43
  def insert(*args, **_arg1, &block); end

  # source://railties//lib/rails/configuration.rb#50
  ...
  #
  # source://railties//lib/rails/configuration.rb#87
...
class Rails::Engine < ::Rails::Railtie
  ...
  #
  # source://railties//lib/rails/engine.rb#427
  def initialize; end
  ...
  #
  # source://railties//lib/rails/engine.rb#525
  def call(env); end
  ...
  # source://railties//lib/rails/engine.rb#472
  def eager_load!; end
  ...
  # source://railties//lib/rails/engine.rb#425
  def engine_name(*_arg0, **_arg1, &_arg2); end

  # Defines additional Rack env configuration that is added on each call.
  #
  # source://railties//lib/rails/engine.rb#531
  def env_config; end
  ...
  #
  # source://railties//lib/rails/engine.rb#441
  def load_console(app = T.unsafe(nil)); end

  # Load Rails generators and invoke the registered hooks.
  # Check <tt>Rails::Railtie.generators</tt> for more info.
  #
  # source://railties//lib/rails/engine.rb#465
  def load_generators(app = T.unsafe(nil)); end

  # Load Rails runner and invoke the registered hooks.
  # Check <tt>Rails::Railtie.runner</tt> for more info.
  #
  # source://railties//lib/rails/engine.rb#450
  ...
  #
  # source://railties//lib/rails/engine.rb#457
  ...
  # @return [Boolean]
  #
  # source://railties//lib/rails/engine.rb#653
  def routes?; end

  protected

  # source://railties//lib/rails/engine.rb#658
  ...
  # source://railties//lib/rails/engine.rb#706
  ...
  # source://railties//lib/rails/engine.rb#664
  ...
  class << self
    ...
    #
    # source://railties//lib/rails/engine.rb#351
    def called_from; end
    ...
    # source://railties//lib/rails/engine.rb#376
    ...
    #
    # source://railties//lib/rails/engine.rb#414
    def find(path); end

    # source://railties//lib/rails/engine.rb#372
    def find_root(from); end
    ...
    # source://railties//lib/rails/engine.rb#382
    def isolate_namespace(mod); end
...
class Rails::Engine::Configuration < ::Rails::Railtie::Configuration
  ...
  # source://railties//lib/rails/engine/configuration.rb#82
  ...
  # source://railties//lib/rails/engine/configuration.rb#86
  ...
  # source://railties//lib/rails/engine/configuration.rb#78
  ...
  # source://railties//lib/rails/engine/configuration.rb#74
  def root=(value); end
end
...
class Rails::MailersController < ::Rails::ApplicationController
  ...
  # source://railties//lib/rails/mailers_controller.rb#79
  def find_part(format); end

  # source://railties//lib/rails/mailers_controller.rb#67
  def find_preferred_part(*formats); end

  # source://railties//lib/rails/mailers_controller.rb#55
  def find_preview; end

  # source://railties//lib/rails/mailers_controller.rb#91
  def locale_query(locale); end

  # source://railties//lib/rails/mailers_controller.rb#87
  def part_query(mime_type); end

  # source://railties//lib/rails/mailers_controller.rb#95
  def set_locale; end

  # @return [Boolean]
  #
  # source://railties//lib/rails/mailers_controller.rb#51
...
# source://railties//lib/rails/paths.rb#4
module Rails::Paths; end

# source://railties//lib/rails/paths.rb#109
class Rails::Paths::Path
  ...
  # source://railties//lib/rails/paths.rb#166
  def <<(path); end

  # source://railties//lib/rails/paths.rb#127
  def absolute_current; end

  # source://railties//lib/rails/paths.rb#148
  def autoload!; end

  # source://railties//lib/rails/paths.rb#156
  def autoload?; end
  ...
  # source://railties//lib/rails/paths.rb#131
  def children; end

  # source://railties//lib/rails/paths.rb#171
  def concat(paths); end

  # source://railties//lib/rails/paths.rb#162
  def each(&block); end
  ...
  #
  # source://railties//lib/rails/paths.rb#207
  def existent; end

  # source://railties//lib/rails/paths.rb#218
  ...
  # source://railties//lib/rails/paths.rb#183
  def extensions; end

  # source://railties//lib/rails/paths.rb#138
  def first; end

  # Returns the value of attribute glob.
  #
  # source://railties//lib/rails/paths.rb#112
  def glob; end
  ...
  # source://railties//lib/rails/paths.rb#142
  def last; end
  ...
  # source://railties//lib/rails/paths.rb#179
  def to_ary; end

  # source://railties//lib/rails/paths.rb#175
  def unshift(*paths); end

  private

  # source://railties//lib/rails/paths.rb#225
...
#
# source://railties//lib/rails/paths.rb#46
class Rails::Paths::Root
  ...
  # source://railties//lib/rails/paths.rb#80
  def all_paths; end

  # source://railties//lib/rails/paths.rb#84
  def autoload_once; end

  # source://railties//lib/rails/paths.rb#92
  def autoload_paths; end

  # source://railties//lib/rails/paths.rb#88
  def eager_load; end

  # source://railties//lib/rails/paths.rb#72
  def keys; end

  # source://railties//lib/rails/paths.rb#96
  def load_paths; end

  # Returns the value of attribute path.
  #
  # source://railties//lib/rails/paths.rb#47
  def path; end
  ...
  # source://railties//lib/rails/paths.rb#68
  def values; end

  # source://railties//lib/rails/paths.rb#76
...
#
# source://railties//lib/rails/railtie.rb#118
class Rails::Railtie
  include ::Rails::Initializable
  extend ::Rails::Initializable::ClassMethods
  ...
  #
  # source://railties//lib/rails/railtie.rb#210
  def initialize; end
  ...
  # source://railties//lib/rails/railtie.rb#208
  ...
  # source://railties//lib/rails/railtie.rb#232
  def run_console_blocks(app); end
  ...
  class << self
    ...
    # source://railties//lib/rails/railtie.rb#127
    ...
    #
    # source://railties//lib/rails/railtie.rb#173
    def configure(&block); end

    # source://railties//lib/rails/railtie.rb#143
    def console(&blk); end
    ...
    # @private
    #
    # source://railties//lib/rails/railtie.rb#133
    def inherited(base); end

    # Since Rails::Railtie cannot be instantiated, any methods that call
    # +instance+ are intended to be called only on subclasses of a Railtie.
    #
    # source://railties//lib/rails/railtie.rb#166
    def instance; end

    # source://railties//lib/rails/railtie.rb#159
    def railtie_name(name = T.unsafe(nil)); end

    # source://railties//lib/rails/railtie.rb#139
    def rake_tasks(&blk); end

    # source://railties//lib/rails/railtie.rb#147
    def runner(&blk); end

    # source://railties//lib/rails/railtie.rb#129
    def subclasses; end

    private

    # source://railties//lib/rails/railtie.rb#178
    def generate_railtie_name(string); end

    # If the class method does not have a method, then send the method call
    # to the Railtie instance.
    #
    # source://railties//lib/rails/railtie.rb#188
    ...
    #
    # source://railties//lib/rails/railtie.rb#200
...
# source://railties//lib/rails/railtie.rb#123
...
class Rails::Secrets
  class << self
    ...
    # source://railties//lib/rails/secrets.rb#34
    def key; end
    ...
    # source://railties//lib/rails/secrets.rb#55
    ...
    # source://railties//lib/rails/secrets.rb#100
    def encryptor; end

    # @raise [MissingKeyError]
    #
    # source://railties//lib/rails/secrets.rb#60
    def handle_missing_key; end

    # source://railties//lib/rails/secrets.rb#70
    def key_path; end
    ...
    # source://railties//lib/rails/secrets.rb#86
...
class Rails::SourceAnnotationExtractor
  ...
  #
  # source://railties//lib/rails/source_annotation_extractor.rb#94
  def initialize(tag); end

  # Prints the mapping from filenames to annotations in +results+ ordered by filename.
  # The +options+ hash is passed to each annotation's +to_s+.
  #
  # source://railties//lib/rails/source_annotation_extractor.rb#146
  ...
  #
  # source://railties//lib/rails/source_annotation_extractor.rb#134
  def extract_annotations_from(file, pattern); end

  # Returns a hash that maps filenames under +dirs+ (recursively) to arrays
  # with their annotations.
  #
  # source://railties//lib/rails/source_annotation_extractor.rb#100
  def find(dirs); end
  ...
  #
  # source://railties//lib/rails/source_annotation_extractor.rb#108
  def find_in(dir); end
...
# source://railties//lib/rails/source_annotation_extractor.rb#16
class Rails::SourceAnnotationExtractor::Annotation < ::Struct
  ...
  #
  # source://railties//lib/rails/source_annotation_extractor.rb#57
  def to_s(options = T.unsafe(nil)); end

  class << self
    # source://railties//lib/rails/source_annotation_extractor.rb#17
    def directories; end

    # source://railties//lib/rails/source_annotation_extractor.rb#37
    def extensions; end
    ...
    #
    # source://railties//lib/rails/source_annotation_extractor.rb#23
    ...
    # source://railties//lib/rails/source_annotation_extractor.rb#27
    def tags; end
  end
end
...
#
# source://railties//lib/rails/source_annotation_extractor.rb#161
