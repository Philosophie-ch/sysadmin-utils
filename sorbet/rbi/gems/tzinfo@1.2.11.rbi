...
# @private
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#103
class TZInfo::AbsoluteDayOfYearTransitionRule < ::TZInfo::DayOfYearTransitionRule
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#111
  def is_always_first_day_of_year?; end

  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#116
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#131
  def get_day(year); end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#136
  def hash_args; end
end
...
class TZInfo::AnnualRules
  ...
  #
  # source://tzinfo//lib/tzinfo/annual_rules.rb#23
  def dst_end_rule; end

  # The offset that applies when daylight savings time is in force.
  #
  # source://tzinfo//lib/tzinfo/annual_rules.rb#17
  def dst_offset; end
  ...
  # force.
  #
  # source://tzinfo//lib/tzinfo/annual_rules.rb#14
  def std_offset; end
  ...
  #
  # source://tzinfo//lib/tzinfo/annual_rules.rb#46
...
# TimezoneOffset.
#
# source://tzinfo//lib/tzinfo/annual_rules.rb#10
...
# @private
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#246
class TZInfo::DayOfMonthTransitionRule < ::TZInfo::DayOfWeekTransitionRule
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#247
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#254
  def ==(r); end
  ...
  # specified by the rule for the given offset and year.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#266
  def get_day(year); end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#280
  def hash_args; end

  # Returns the day the week starts on for a month starting on a Sunday.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#262
...
class TZInfo::DayOfWeekTransitionRule < ::TZInfo::TransitionRule
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#203
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#222
  def ==(r); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#212
  def is_always_first_day_of_year?; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#217
  def is_always_last_day_of_year?; end
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#233
  def day_of_week; end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#236
  def hash_args; end

  # Returns the month of the year (1 to 12).
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#230
  def month; end
end
...
# @private
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#69
class TZInfo::DayOfYearTransitionRule < ::TZInfo::TransitionRule
  ...
  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#88
  def hash_args; end

  # @return [Integer] the day multipled by the number of seconds in a day.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#85
  def seconds; end
end
...
# @private
#
# source://tzinfo//lib/tzinfo/posix_time_zone_parser.rb#11
...
# @private
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#148
class TZInfo::JulianDayOfYearTransitionRule < ::TZInfo::DayOfYearTransitionRule
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#155
  def initialize(day, transition_at = T.unsafe(nil)); end

  # Determines if this JulianDayOfYearTransitionRule is equal to another
  # instance.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#174
  def ==(r); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#162
  def is_always_first_day_of_year?; end
  ...
  # specified by the rule for the given offset and year.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#183
  def get_day(year); end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#192
  def hash_args; end
end

# The 60 days in seconds.
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#149
TZInfo::JulianDayOfYearTransitionRule::LEAP = T.let(T.unsafe(nil), Integer)

# The length of a non-leap year in seconds.
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#152
...
# @private
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#290
class TZInfo::LastDayOfMonthTransitionRule < ::TZInfo::DayOfWeekTransitionRule
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#291
  ...
  # instance.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#297
  def ==(r); end
  ...
  # specified by the rule for the given offset and year.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#306
  def get_day(year); end
end
...
# @private
#
# source://tzinfo//lib/tzinfo/posix_time_zone_parser.rb#18
class TZInfo::PosixTimeZoneParser
  ...
  #
  # source://tzinfo//lib/tzinfo/posix_time_zone_parser.rb#21
  ...
  # @raise [InvalidPosixTimeZone]
  #
  # source://tzinfo//lib/tzinfo/posix_time_zone_parser.rb#130
  ...
  # @raise [InvalidPosixTimeZone]
  #
  # source://tzinfo//lib/tzinfo/posix_time_zone_parser.rb#105
...
module TZInfo::RubyCoreSupport
  class << self
    ...
    # @return [Object] `o`.
    #
    # source://tzinfo//lib/tzinfo/ruby_core_support.rb#163
    def untaint(o); end
  end
end
...
class TZInfo::RubyDataSource < ::TZInfo::DataSource
  ...
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#16
  def initialize; end

  # Returns an array of all the available ISO 3166-1 alpha-2
  # country codes.
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#93
  def country_codes; end
  ...
  # are links to other timezones.
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#76
  def linked_timezone_identifiers; end
  ...
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#36
  def load_timezone_info(identifier); end

  # Returns an array of all the available timezone identifiers.
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#62
  def timezone_identifiers; end

  # Returns the name of this DataSource.
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#99
  def to_s; end
  ...
  #
  # source://tzinfo//lib/tzinfo/ruby_data_source.rb#121
...
class TZInfo::TimeOrDateTime
  ...
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#263
  def +(seconds); end
  ...
  # range for Times, then an exception will be raised by the Time class.
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#280
  def -(seconds); end
  ...
  # Integer#<=>.
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#236
  ...
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#289
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#311
  def eql?(todt); end

  # Returns a hash of this TimeOrDateTime.
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#316
  def hash; end
  ...
  #
  # source://tzinfo//lib/tzinfo/time_or_datetime.rb#209
  def usec; end
  ...
  class << self
    ...
    # calling the block.
    #
    # source://tzinfo//lib/tzinfo/time_or_datetime.rb#331
...
class TZInfo::Timezone
  ...
  #
  # source://tzinfo//lib/tzinfo/timezone.rb#624
  def <=>(tz); end

  # Dumps this Timezone for marshalling.
  #
  # source://tzinfo//lib/tzinfo/timezone.rb#641
  def _dump(limit); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/timezone.rb#631
  def eql?(tz); end
  ...
  #
  # source://tzinfo//lib/tzinfo/timezone.rb#636
  def hash; end
  ...
  #
  # source://tzinfo//lib/tzinfo/timezone.rb#669
  def raise_unknown_timezone; end

  class << self
    # Loads a marshalled Timezone.
    #
    # source://tzinfo//lib/tzinfo/timezone.rb#646
    def _load(data); end
    ...
    # Returns the current DataSource.
    #
    # source://tzinfo//lib/tzinfo/timezone.rb#664
    def data_source; end
    ...
    # identifiers.
    #
    # source://tzinfo//lib/tzinfo/timezone.rb#659
    ...
    #
    # source://tzinfo//lib/tzinfo/timezone.rb#652
...
# savings time.
#
# source://tzinfo//lib/tzinfo/transition_rule.rb#6
class TZInfo::TransitionRule
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#33
  def hash; end
  ...
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#11
  ...
  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo//lib/tzinfo/transition_rule.rb#40
  def hash_args; end

  # source://tzinfo//lib/tzinfo/transition_rule.rb#44
...
class TZInfo::ZoneinfoDataSource < ::TZInfo::DataSource
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#190
  def initialize(zoneinfo_dir = T.unsafe(nil), alternate_iso3166_tab_path = T.unsafe(nil)); end

  # Returns an array of all the available ISO 3166-1 alpha-2
  # country codes.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#274
  def country_codes; end
  ...
  # timezone_identifers.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#251
  def data_timezone_identifiers; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#284
  def inspect; end
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#259
  def linked_timezone_identifiers; end
  ...
  # @raise [InvalidCountryCode]
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#266
  def load_country_info(code); end
  ...
  # identifier is invalid.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#216
  def load_timezone_info(identifier); end
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#279
  def to_s; end

  # The zoneinfo directory being used.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#160
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#497
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#380
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#346
  ...
  # directory.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#311
  ...
  class << self
    ...
    #
    # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#142
    ...
    #
    # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#155
    ...
    #
    # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#292
    ...
    #
    # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#118
    def search_path; end
    ...
    # Set to nil to revert to the default paths.
    #
    # source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#131
...
#
# source://tzinfo//lib/tzinfo/zoneinfo_data_source.rb#93
...
# @private
#
# source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#13
class TZInfo::ZoneinfoTimezoneInfo < ::TZInfo::TransitionDataTimezoneInfo
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#28
  ...
  # Times.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#301
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#212
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#53
  def check_read(file, bytes); end

  # Converts an array of rule transitions to hashes.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#203
  ...
  # Hash.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#331
  ...
  # rule offset.
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#184
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#45
  ...
  # @return [Boolean]
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#172
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#149
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#251
  ...
  #
  # source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#277
...
# @private
#
# source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#14
...
#
# source://tzinfo//lib/tzinfo/zoneinfo_timezone_info.rb#19
